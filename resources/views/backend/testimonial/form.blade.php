...
<div class="card-body">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">Comments <span style="color:red" >*</span></label>

    <textarea name="comment" id="" cols="30" rows="10" class="form-control">{!!old('comment',@$edit->comment)!!}</textarea>
