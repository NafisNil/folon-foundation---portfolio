                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <td>
                      ...
                      <a href="{{route('whatwedo.edit',[$item])}}" title="Edit"><button class="btn btn-outline-info btn-sm"><i class="fas fa-pen-square"></i></button></a>




                      <form action="{{route('whatwedo.destroy',[$item])}}" method="POST">
                        @method('DELETE')
                        @csrf
